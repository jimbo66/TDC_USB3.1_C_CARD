...
DeviceDscr:   
      ...
      dw   4310H      ;; Vendor ID
      dw   0808H      ;; Product ID (Sample Device)    
 ;     dw   0B404H      ;; Vendor ID
 ;     dw   1386H      ;; Product ID (Sample Device)   
      dw   0C05H      ;; Product version ID
...
;; Isoc IN Endpoint Descriptor
      ...
      db   ET_ISO            ;; Endpoint type
      db   00H               ;; Maximun packet size (LSB) 
      db   02H               ;; Max packect size (MSB) 00100b 1x512 byte packets/uFrame
      db   01H               ;; Polling interval
...
;; Alt Interface 7 Descriptor - Bulk IN-OUT
      db   DSCR_INTRFC_LEN   ;; Descriptor length
      db   DSCR_INTRFC       ;; Descriptor type
      db   0                 ;; Zero-based index of this interface
      db   7                 ;; Alternate setting
      db   2                 ;; Number of end points 
      db   0ffH              ;; Interface class
      db   00H               ;; Interface sub class
      db   00H               ;; Interface sub sub class
