...
/*********************vendor command*************************************************/
 //pausebreak add 
#define SET_FULL_TEST		0xb0 	//test full speed  
#define SET_HIGH_TEST		0xb1 	//test high speed  

#define SET_LOW_TEST		0xb2	//test low speed
#define CHECK_PWR			0xb3    //check PWR
//#define CHECK_J				0xb4
#define RENUM_CMD			0xb4	//renum
#define CHECK_K				0xb5
#define VOLT_DATA_UP		0xb6
#define CHECK_FULL_J		0xb7	//full speed data_j
#define CHECK_FULL_K		0xb8	//full speed data_k
#define READ_DATA_T			0xb9	//test
#define CHECK_J				0xba	//test
//#define RENUM_CMD			0xba	//renum
#define U30_CTRL			0xbb //pbtest 2015.09.16
//#define DEVICE_ID			0xbb 	//device id test
//#define READ_DEVICE_ID	0xbc 	//read device id test
#define CHECK_PIN			0xbc	//read ADC new value
#define PCB_CS				0xbd	//read Rev. of PCB
#define CHECK_J_T			0xbe	//test
#define CHECK_K_T			0xbf

#define Def_CCSW_TIME		0xc0    //define cc pin floating time,when switch between top and bottom
#define SWITCH_CC_CFG		0xc1	//config switch cc pin with USB3.0 or USB2.0
#define GET_TURNON_TIME     0xc2 
#define RLS_HPD				0xc3	//assert RLS_HPD(PB5) high or low,	1:high 	0:low
#define GET_RSLT			0xc4	//get video card check result.one byte.
#define RST_VIDEO			0xc5	//reset video card.
//#define xxxx				0xc6
#define SET_WAIT_TIME		0xc7	//set waitTIME 
